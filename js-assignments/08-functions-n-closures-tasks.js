...
function logger(func, logFunc) {
    ...
    //     console.log(func + '('+ value +') starts');
    //     console.log(func + '('+ func(value) +') ends');
    //     return logFunc(func(value));
    // }
    throw new Error('Not implemented');
}
...
function partialUsingArguments(fn) {
    let firstArgs = [].slice.call(arguments).slice(1);
    return function() {
        let secondArgs = [].slice.call(arguments);
        let args = firstArgs.concat(secondArgs);
